// Thia variable keeps track of whose turn it is.
let activePlayer = 'X';
// This array astores an array of moves. We use this to derermine win conditions.
let selectedSquares = [];

// This function is for placing an x or o in a square.
function placeXOrO(squareNumber) {
    // This condition ensures a squre hasn't been selected already.
    // The .some() method is used to check each element of the selectSquare array to see if contains the square number clicked on.
    if (! selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        new Audio('./media/place1.mp3').play();
...
function checkWinConditions() {
    ...
    // O 6, 7, 8 condition
     ...
     // O 0, 3, 6 condition
    else if (arrayIncludes('00', '3O', '6O')) { drawWinLine(100, 50, 100, 558) }
    // O 1, 4, 7 condition
